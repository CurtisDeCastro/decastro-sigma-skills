# the restaurant Day-part Heatmap — Sigma plugin
...
## Register + embed
1. Host `index.html` (e.g. `http://localhost:8080/daypart-heatmap/` or a static host).
...
Bind to a 7×24 day-part source (see the workbook builder skill for a full 2-page workbook generator that builds the source, KPIs, agents, and this plugin).
